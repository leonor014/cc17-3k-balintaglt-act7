...
class MainViewModel : ViewModel() {
    ...
    private val placeData = mapOf(
        "Kid-Friendly Places" to listOf(
            Place("Baguio Botanical Garden", R.drawable.botanical, "Kid-Friendly Places", "A large garden with trails and picnic areas, ideal for family outings.  ", "Location: Leonard Wood Road, Baguio City"),
            Place("Bencab Museum", R.drawable.bencab, "Kid-Friendly Places", "Art museum with gardens, a pond, and a space for children to explore.  ", "Location: Km 6 Asin Rd  "),
            Place("Skyranch", R.drawable.skyranch, "Kid-Friendly Places", "Sky Ranch is a family-friendly amusement park located near SM City Baguio. It features a Ferris wheel, drop tower, carousel, and other rides that both kids and adults can enjoy. Its elevated location offers scenic views of the mountains and city, making it a popular spot for taking photos. The park’s vibrant atmosphere and mix of thrilling and gentle rides make it an ideal place for families.", "Location: Luneta Hill, Upper Session Road (beside SM City Baguio), Baguio City"),

        ),

        "Parks" to listOf(
            Place("Wright Park", R.drawable.wright_park, "Parks", "Known for its horseback riding and picturesque scenery.  ", "Location: Gibraltar Road, Baguio City"),
            Place("Burnham Park", R.drawable.burnham, "Parks", "A popular spot with boating, biking, and playgrounds for relaxation and family activities.  ", "Location: Jose Abad Santos Dr "),
            Place("Tree Top Adventure", R.drawable.tree_top_adventure, "Parks", "Tree Top Adventure offers thrilling outdoor experiences and eco-friendly rides set amidst the lush pine trees of Camp John Hay. Activities include ziplining, tree drops, canopy rides, and trekking. It’s a popular destination for adventure seekers and families looking for an exciting day in nature, and safety measures are in place for all activities.", "Location: Camp John Hay, Loakan Rd, Baguio City"),
